...
export const chibiInitialState: WorldState = {
  ...
  factions: {
    [factionCao]: {
      id: factionCao,
      name: "曹军",
      leaderId: personCaoCao,
      strength: 220000,
    },
    [factionSun]: {
      id: factionSun,
      name: "孙权军",
      leaderId: personSunQuan,
      strength: 30000,
    },
    [factionLiu]: {
      id: factionLiu,
      name: "刘备军",
      leaderId: personLiuBei,
      strength: 20000,
    },
  },
  persons: {
    ...
    [personLiuBei]: {
      id: personLiuBei,
      name: "刘备",
      factionId: factionLiu,
      role: "主公",
      locationId: locationXiaKou,
      status: "在世",
    },
    [personZhouYu]: {
      id: personZhouYu,
...
export const chibiRewrites = {
  ...
  coarse: {
    text: "曹操采纳贾诩建议，退守许都",
    submittedAt: "2026-07-12T00:00:02.000Z",
  },
