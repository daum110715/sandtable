...
> 状态：候选架构。模块划分、不变量与 Pi 使用范围均须由项目所有者逐项确认。

## 项目所有者决策

- D007 Pi 的具体使用层级：________
- D008 AI 与世界规则的权责关系：________
- D014 模型选择策略：________
- D015 Pi 接入方式：________
- 模块划分是否采用下述候选：________
...
具体包版本、SDK 与 RPC 的选择保持待定，直到 MVP 的部署形态和进程隔离要求确定。
